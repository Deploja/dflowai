      ...
      <div className="flex items-center space-x-6 mb-3">
        ...
        <div className="relative">
          ...
          <Input
            ...
            className="pl-10 w-64 bg-white border-gray-300 text-gray-900 placeholder:text-gray-400 focus:border-emerald-500"
          />
        </div>
        ...
        <div className="flex items-center space-x-2">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent className="bg-white border-gray-300 z-50">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent className="w-56 bg-white border-gray-300 z-50">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent className="w-56 bg-white border-gray-300 z-50">
            {statusOptions.map((status) => (
              <DropdownMenuItem key={status.id} className="hover:bg-gray-100">
                <div className="flex items-center space-x-2 w-full">
                  <Checkbox
                    id={`status-${status.id}`}
