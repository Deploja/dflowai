...
export function CandidatePipelineFilter({
  ...
  return (
    <div className="  border-gray-200 mr-6 bg-card rounded-b-none rounded-t mt-20 flex px-4 py-3 ">
      <div className="flex items-center space-x-6 mb-3">
        ...
        <div className="flex items-center space-x-2">
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" className="font-medium rounded-sm">
                Consultant Pipeline
                <ChevronDown className="h-4 w-4 ml-1" />
              </Button>
            </DropdownMenuTrigger>
            <DropdownMenuContent className=" font-medium rounded-lg">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent className="font-medium rounded-lg">
            {responsibleUsers.map((user) => (
              <DropdownMenuItem key={user.id} className="">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent className="font-medium rounded-sm">
            {statusOptions.map((status) => (
              <DropdownMenuItem key={status.id} className="">
                <div className="flex items-center space-x-2 w-full">
                  <Checkbox
                    id={`status-${status.id}`}
