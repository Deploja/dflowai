    ...
    <div className="bg-white border-b border-gray-200 px-6 py-4">
      <div className="flex justify-between items-center">
        <div className="flex items-center space-x-4">
          ...
          <Button variant="outline" className="border-gray-300 text-gray-700 hover:bg-gray-50 text-sm font-medium">
          ...
          {isAdminOrOwner && (
            <Button 
              ...
              className={showAllAsAdmin ? "bg-blue-600 hover:bg-blue-700 text-white" : "border-gray-300 text-gray-700 hover:bg-gray-50"}
            >
        ...
        <div className="flex items-center space-x-3">
          ...
          <span className="bg-blue-600 text-white text-xs px-2 py-1 rounded-full font-medium">0</span>
        </div>
      </div>
    </div>
  );
