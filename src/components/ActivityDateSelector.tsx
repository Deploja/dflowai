...
export function ActivityDateSelector({
  selectedDate,
  onDateChange,
}: ActivityDateSelectorProps) {
        ...
        <PopoverTrigger asChild>
          ...
          >
            <div className="flex items-center">
              <CalendarIcon className="text-sm font-medium text-gray-900 hover:text-white cursor-pointer flex-1" />
              {selectedDate ? format(selectedDate, "yyyy-MM-dd") : "Last acty"}
            </div>
            <ChevronDown className="h-4 w-4 text-gray-500" />
          </Button>
        </PopoverTrigger>
        <PopoverContent
          className="w-96 p-0 bg-white/50 text-gray-900 backdrop-blur border border-gray-200 shadow-lg z-50"
          align="start"
          sideOffset={5}
        >
          {!showCalendar ? (
            <div className="flex">
              {/* Left side - Presets */}
              <div className="w-32  backdrop-blurshadow-lg">
                <div className="p-3 ">
                ...
                <div className="py-1">
                  {presetOptions.map((option) => (
                    <button
                      key={option.label}
                      className="w-full px-3 py-2 text-left text-sm hover:text-gray-700 hover:scale-110 transition-transform"
                  ...
                  <div>
                    ...
                    <div className="flex items-center space-x-2">
                      <input
                        type="date"
                        value={
                          endDate ? format(endDate, "yyyy-MM-dd") : "2025-06-24"
                        }
                        onChange={(e) =>
                          handleEndDateChange(
                            e.target.value
            ...
            <div className="flex">
              ...
              <div className="flex-1">
                <div className="p-3  flex items-center justify-between">
                  <button
                    className="text-sm text-gray-900 hover:text-gray-700 hover:scale-110 transition-transform"
                    onClick={() => setShowCalendar(false)}
                  >
                    ← Back
                  </button>
                  <div className="flex items-center space-x-2">
                    <button className="p-1 hover:text-gray-700 hover:scale-110 transition-transform">
                ...
                <div className="p-3">
                  ...
                  <div className="grid grid-cols-8 gap-1 text-xs">
                    ...
                    <button className="py-1 text-center hover:bg-blue-100 rounded">
                      26
                    </button>
                    <button className="py-1 text-center hover:bg-blue-100 rounded">
                      27
                    ...
                    <button className="py-1 text-center bg-blue-600 text-white rounded">
                      24
                    </button>
                    <button className="py-1 text-center hover:bg-blue-100 rounded">
                      25
                    ...
                    <button className="py-1 text-center hover:bg-blue-100 rounded text-gray-400">
                      1
                    </button>
                    <button className="py-1 text-center hover:bg-blue-100 rounded text-gray-400">
                      2
