        ...
        <CardContent className="flex items-center justify-center py-16">
          <div className="text-center text-gray-600 dark:text-gray-400">
            ...
            <p className="text-base">
              Try different search terms or filter less specifically.
            </p>
          </div>
        </CardContent>
      </Card>
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        {jobs.map((job) => (
          <Card
            key={job.id}
            className=" border-gray-200 dark:border-gray-800 hover:shadow-lg transition-all duration-200 hover:border-gray-300 dark:hover:border-gray-700"
          >
              ...
              <div className="flex items-start justify-between">
                  ...
                  <div className="flex items-start space-x-3">
                    <div className="flex-1">
                      <CardTitle className="text-xl text-gray-900 dark:text-gray-100 mb-2">
                        {job.title}
                        <Badge
                          className={`ml-3 text-xs ${getSourceBadgeColor(
                            job.source
                          )}`}
                        >
                ...
                <div className="flex flex-col items-end space-y-2 ml-6">
                  ...
                  {job.salary && (
                    <Badge
                      variant="secondary"
                      className="bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 whitespace-nowrap"
                    >
                      {job.salary}
                    </Badge>
                  )}
            ...
            <CardContent className="pt-0">
              ...
              <div className="flex items-center justify-between">
                <div className="text-sm text-gray-500 dark:text-gray-400">
                  Published:{" "}
                  {new Date(job.published).toLocaleDateString("en-US")}
                </div>
