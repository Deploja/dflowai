...
export function ConsultantsHeader({ onAddConsultant }: ConsultantsHeaderProps) {
  return (
    <div className="flex justify-between items-center">
      <div>
        <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100">Consultants & Revenue</h1>
        <p className="text-gray-600 dark:text-gray-400 mt-2">Manage your consultants and track revenue</p>
      </div>
