            ...
            return (
              <SidebarMenuItem key={item.title}>
                <SidebarMenuButton
                  asChild
                  isActive={isActive}
                  className="text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800/50 data-[active=true]:bg-gray-400/80 data-[active=true]:text-white dark:data-[active=true]:bg-white/80 dark:data-[active=true]:text-black"
                >
                  <Link to={item.url}>
            ...
            >
              <CollapsibleTrigger asChild>
                <SidebarMenuButton
                  ...
                  className="text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 data-[active=true]:bg-gray-900 data-[active=true]:text-white/50 dark:data-[active=true]:bg-gray-100/50 dark:data-[active=true]:text-black"
                >
                  <Users className="h-4 w-4" />
                    ...
                    return (
                      <SidebarMenuSubItem key={subItem.title}>
                        <SidebarMenuSubButton
                          asChild
                          isActive={isSubActive}
                          className="text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 data-[active=true]:bg-gray-900 data-[active=true]:text-white/50 dark:data-[active=true]:bg-gray-100/50 dark:data-[active=true]:text-black"
                        >
                          <Link to={subItem.url}>
                            <SubIcon className="h-4 w-4" />
                            <span>{subItem.title}</span>
