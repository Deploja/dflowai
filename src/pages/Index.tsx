  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white via-gray-50 to-white dark:from-zinc-950 dark:via-zinc-900 dark:to-zinc-950 relative">
      ...
      <section className="relative h-screen ocean-hero">
        ...
        <header className="sticky  top-0 left-0 right-0 z-50  bg-inherit/50 shadow-md backdrop-blur-md border-b border-white/10">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-16">
              <div className="flex items-center space-x-3">
                <div className="flex items-center space-x-1">
                  <span className="text-3xl font-bold text-white font-deploja tracking-wider">
                    DFLOW
                  </span>
                  <Sparkles className="h-5 w-5 text-white/80" />
                  <span className="text-3xl font-bold text-white/90 font-deploja tracking-wider">
                    AI
                  </span>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="flex items-center space-x-3">
                  <Link to="/dashboard">
                    <Button className="bg-white/50 hover:bg-gray-300/50 text-gray-900 font-medium rounded-lg">
                      Get Started
                    </Button>
                  </Link>
                </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="animate-fade-in text-white">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-16">
                <Button
                  size="lg"
                  className="bg-white/50 hover:bg-gray-300/50 hover-text-gray-500 text-gray-900 font-semibold px-10 py-4 text-lg rounded-lg shadow-md border-0"
                >
                ...
                <Button
                  size="lg"
                  className="bg-white/50 hover:bg-gray-300/50 text-gray-900 font-semibold px-10 py-4 text-lg rounded-lg border-0"
                >
                  Work at DflowAI
                </Button>
              </div>
